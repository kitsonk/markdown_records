...
// source-hash: 736e76391e2574773f61fa981126e2115c80e3c6
let wasm;
 ...
 * @returns {any}
 */
export function toRecords(markdown) {
  try {
    ...
    wasm.toRecords(retptr, ptr0, len0);
...
const wasm_url = new URL("markdown_records_bg.wasm", import.meta.url);
 ...
 *   exports: { toRecords: typeof toRecords }
 * }>}
 */
